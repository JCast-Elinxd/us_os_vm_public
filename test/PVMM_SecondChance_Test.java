...
import ur_os.virtualmemory.PVMM_SecondChance;

public class PVMM_SecondChance_Test {
    ...
    public static void main(String[] args) {
        ...
        PVMM_SecondChance secondChance = new PVMM_SecondChance();
        ...
        for (int time = 0; time < REFERENCES.length; time++) {
            ...
            if (pageTable.isPageValid(page)) {
                ...
                if (loadedPages < 3) {
                    ...
                    int victim = secondChance.getVictim(memoryAccesses, pageTable);
