...
public class PVMM_MRU_Test {
    ...
    public static void main(String[] args) {
        ...
        for (int time = 0; time < REFERENCES.length; time++) {
            ...
            if (pageTable.isPageValid(page)) {
                ...
                if (loadedPages < 3) {
                    ...
                    int victim = mru.getVictim(memoryAccesses, pageTable);
        ...
        System.out.println("----------------------------------");
        System.out.println("MRU page faults = " + pageFaults);
        System.out.println("Resultado esperado = 18");
    }
}